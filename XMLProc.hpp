...
#define XMLATTRIBUTE_DATEFILTERSTART		_T("dateFilterStart")

#define XMLATTRIBUTE_SMTP_LOTUSPART		_T("lotusPart")
#define XMLATTRIBUTE_SMTP_EMAILPART		_T("emailPart")
#define XMLATTRIBUTE_SMTP_EMAILSEP		_T("emailSeparator")
#define XMLATTRIBUTE_SMTP_EMAILPREF		_T("emailPreference")
#define XMLATTRIBUTE_SMTP_PARTSSEP		_T("partsSeparator")
...
//	XalanSourceTreeParserLiaison*	theLiaison;
	...
	MutableNodeRefList* m_entryFilterList;
	int m_currentEntryFilterIndex;
	bool m_entryFilterListInitialized;
